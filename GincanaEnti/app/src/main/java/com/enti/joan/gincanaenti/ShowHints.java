...
public class ShowHints extends AppCompatActivity /*Implements View.OnclickListener */{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptador = new Adaptador(this, listaVersiones);
    ...
    @Override protected void onActivityResult(int requestCode, int resultCode, Intent data){
        if(requestCode == 8888 && resultCode == RESULT_OK){
            ...
            String idNext = data.getExtras().getString("idNext");
            Toast.makeText(this, id+""+tipo+""+ des+""+latitud+""+ longitud+""+idNext, Toast.LENGTH_LONG).show();
        }
    }
